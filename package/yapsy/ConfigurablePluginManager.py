...
class ConfigurablePluginManager(PluginManagerDecorator):
    ...
    def __addPluginToConfig(self, category_name, plugin_name):
        ...
        if not self.config_parser.has_option(self.CONFIG_SECTION_NAME, option_name):
            ...
            past_list_str = self.config_parser.get(
                self.CONFIG_SECTION_NAME, option_name
            )
            ...
            if plugin_name not in past_list:
                ...
                self.config_parser.set(
                    self.CONFIG_SECTION_NAME, option_name, new_list_str
                )
                return self.config_has_changed()
    ...
    def registerOptionFromPlugin(
        self, category_name, plugin_name, option_name, option_value
    ):
        """
    ...
    def hasOptionFromPlugin(self, category_name, plugin_name, option_name):
        ...
        return self.config_parser.has_section(
            section_name
        ) and self.config_parser.has_option(section_name, option_name)
    ...
    def activatePluginByName(
        self, plugin_name, category_name="Default", save_state=True
    ):
        """
