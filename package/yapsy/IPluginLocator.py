...
class IPluginLocator(object):
    ...
    def getPluginNameAndModuleFromStream(self, fileobj):
        ...
        """
        log.warning(
            "setPluginInfoClass was called but '%s' doesn't implement it." % self
        )
    ...
    def getPluginInfoClass(self):
        ...
        """
        log.warning(
            "getPluginInfoClass was called but '%s' doesn't implement it." % self
        )
        return None
    ...
    def updatePluginPlaces(self, directories_list):
        ...
        """
        log.warning(
            "updatePluginPlaces was called but '%s' doesn't implement it." % self
        )
